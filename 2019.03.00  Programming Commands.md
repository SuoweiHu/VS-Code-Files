...
* [Git-Bash Command](#git-bash-command)
* [CMD Commands](#cmd-commands)
* [Markdown Grammar](#markdown-grammar)
* [Unix Command (works in powerhsell)](#unix-command-works-in-powerhsell)
* [Visual Studio Code](#visual-studio-code)
* [Spyder (Comp1730)](#spyder-comp1730)
* [X](#x)
