...
def grasp_blocks_above():
    ...
    #COMMENT: This is not needed cause the grip will be already opened after going through function "put_down_block()"
    #
...
def put_down_blocks():
    ...
    #robot.lift_down()
    #COMMENT: These extra action is not needed, since the gripper needs to be opened in function "grasp_blocks_above()"
    #
...
def unstack_tower_of_three():
    ...
    robot.gripper_to_folded()
    robot.lift_down()
    #since at the end the robot has its gripper folded at the end
